...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 25 },
    ...
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 6 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 7 },
    ...
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 45, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 45 },
    ...
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 6 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 7, BALL_ULTRA },
    ...
    [TRAINER_CLASS_POKEMON_MASTER] = { _("{PKMN} MASTER"), 100, BALL_LUXURY },
    [TRAINER_CLASS_ROCKET_GRUNT] = { _("TEAM ROCKET"), 10, BALL_ULTRA },
    [TRAINER_CLASS_ROCKET_GRUNT_F] = { _("TEAM ROCKET"), 10, BALL_ULTRA },
    [TRAINER_CLASS_ROCKET_EXEC] = { _("ROCKET EXEC"), 20, BALL_MASTER },
...
static void HandleEndTurn_BattleWon(void)
{
	...
	case TRAINER_CLASS_ROCKET_EXEC:
